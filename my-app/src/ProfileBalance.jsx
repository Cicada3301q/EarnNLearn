        ...
        <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          {transactions.map((transaction, index) => (
              ...
              <Box sx={{ 
                  ...
                  <FiberManualRecordIcon sx={{ color: transaction.type === 'deposit' ? 'green' : 'red', marginRight: 2 }} />
                  <Typography variant="body1" sx={{ flexGrow: 1 }}>{transaction.name}</Typography> {/* flexGrow ensures it takes up available space */}
                  </Box>
